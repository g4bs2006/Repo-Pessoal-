...
**Se DOR = mastigacao:**
> "[primeiro nome], imagina a tranquilidade de sentar para comer o que gosta sem sentir dor ou preocupação..."
> "É exatamente essa segurança que a gente quer te devolver. Faz sentido para você?"
...
> "É exatamente essa confiança que a gente consegue resgatar para você. É esse o resultado que você busca?"
...
**Se DOR = multiplas:**
> "[primeiro nome], imagina a liberdade de poder mastigar de tudo sem dor e ainda sorrir para uma foto com total segurança..."
...
> "É exatamente para isso que existe a avaliação com nossa equipe."
> "A sua avaliação não tem custo nesse primeiro momento."
> "É um horário reservado para o seu atendimento, onde o dentista responsável vai analisar seu caso com calma e indicar a melhor solução."
> "Posso te mostrar os horários disponíveis para a gente deixar o seu reservado?"
