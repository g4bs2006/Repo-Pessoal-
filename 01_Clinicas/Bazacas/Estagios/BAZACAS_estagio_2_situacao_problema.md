...
- `[ESTÁGIO: E2] [NOME: primeiro nome] [NOME_COMPLETO: pendente] [TELEFONE: pendente] [DOR: detalhada] [URGÊNCIA: alta/baixa] [OBJEÇÕES: nenhuma] [ESTADO_EMOCIONAL: estado] [FRASES_CHAVE: "frase"] [AGENDAMENTO: nenhum] [DENTISTA: especialista] [TAGS: tags_aplicadas] [ORIGEM: orgânico] [PRÓXIMA_AÇÃO: entrar no estágio alvo [E3 ou E4] com [ação específica]]`
