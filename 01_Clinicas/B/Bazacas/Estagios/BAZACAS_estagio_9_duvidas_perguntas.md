...
- `[ESTÁGIO: E9] [NOME: primeiro nome] [NOME_COMPLETO: manter] [TELEFONE: manter] [DOR: manter] [URGÊNCIA: manter] [OBJEÇÕES: preço/dúvida/etc.] [ESTADO_EMOCIONAL: estado] [FRASES_CHAVE: manter] [AGENDAMENTO: manter] [DENTISTA: especialista] [TAGS: manter] [ORIGEM: orgânico] [PRÓXIMA_AÇÃO: retornar ao ponto do funil em que parou]`
