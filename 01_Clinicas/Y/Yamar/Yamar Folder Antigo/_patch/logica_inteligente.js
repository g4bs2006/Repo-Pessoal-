...
// REGRA DE OFERTA: sempre 2 opções — 1 de manhã e 1 de tarde —
// exceto quando o lead pediu horário específico ou um período.
// =============================================================
...
// Período solicitado pelo lead: 'manha' | 'tarde' | '' (sem preferência)
...
if (dRaw && hRaw) {
  ...
  // Lead informou apenas a data (sem hora): respeitar o dia pedido
...
// Duplo vínculo: a vaga de manhã mais próxima + a vaga de tarde mais próxima.
// Se um dos períodos não tiver vaga, completa com a próxima vaga disponível.
...
const avisoPeriodoEsgotado =
  `\n\n(No período da ${PERIODO_LABEL} a agenda está cheia — estas opções são da ${PERIODO_OPOSTO}.)`;
