  ...
  **Se o paciente responder "tanto faz" ou não souber escolher a unidade:**
  ...
  - `[ESTÁGIO: E4] [NOME: primeiro nome] [NOME_COMPLETO: pendente] [TELEFONE: pendente] [DOR: manter] [URGÊNCIA: manter] [OBJEÇÕES: nenhuma] [ESTADO_EMOCIONAL: engajado] [FRASES_CHAVE: "frase"] [AGENDAMENTO: nenhum] [DENTISTA: especialista] [ÚLTIMA_MENSAGEM_GI: nenhuma] [TAGS: tag_lead, tag_unidade_arroio/butia/jeronimo] [ORIGEM: orgânico] [PRÓXIMA_AÇÃO: entrar no E5 verificando disponibilidade para [preferência de horário] na unidade [cidade]]`
