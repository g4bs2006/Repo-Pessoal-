...
- `[ESTÁGIO: E7] [NOME: primeiro nome] [NOME_COMPLETO: manter] [TELEFONE: manter] [DOR: manter] [URGÊNCIA: manter] [OBJEÇÕES: nenhuma] [ESTADO_EMOCIONAL: receptivo] [FRASES_CHAVE: manter] [AGENDAMENTO: data_hora ou nenhum] [DENTISTA: especialista] [ÚLTIMA_MENSAGEM_GI: nenhuma] [TAGS: manter] [ORIGEM: orgânico] [PRÓXIMA_AÇÃO: aguardar resposta ou direcionar para E4]`
