...
- `[ESTÁGIO: E1] [NOME: primeiro nome] [NOME_COMPLETO: pendente] [TELEFONE: pendente] [DOR: tipo/detalhe] [URGÊNCIA: baixa/alta] [OBJEÇÕES: nenhuma] [ESTADO_EMOCIONAL: estado] [FRASES_CHAVE: "frase exata"] [AGENDAMENTO: nenhum] [DENTISTA: especialista] [ÚLTIMA_MENSAGEM_GI: nenhuma] [TAGS: tag_lead/tag_cliente] [ORIGEM: orgânico] [PRÓXIMA_AÇÃO: entrar no E2 investigando o problema de [dor relatada]]`
