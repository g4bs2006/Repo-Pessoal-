...
- `[ESTÁGIO: E8] [NOME: primeiro nome] [NOME_COMPLETO: nome] [TELEFONE: telefone] [DOR: manter] [URGÊNCIA: manter] [OBJEÇÕES: nenhuma] [ESTADO_EMOCIONAL: engajado] [FRASES_CHAVE: manter] [AGENDAMENTO: data_hora] [DENTISTA: especialista] [ÚLTIMA_MENSAGEM_GI: nenhuma] [TAGS: tag_lead, tag_unidade_cidade, tag_agendado_sucesso, AGENDOU, Fluxo Agendou] [ORIGEM: orgânico] [PRÓXIMA_AÇÃO: arquivar contato — agendamento finalizado]`
