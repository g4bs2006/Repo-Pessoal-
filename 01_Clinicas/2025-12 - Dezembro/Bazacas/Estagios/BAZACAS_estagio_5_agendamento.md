...
- `[ESTÁGIO: E5] [NOME: primeiro nome] [NOME_COMPLETO: nome completo] [TELEFONE: telefone] [DOR: manter] [URGÊNCIA: manter] [OBJEÇÕES: nenhuma] [ESTADO_EMOCIONAL: engajado] [FRASES_CHAVE: manter] [AGENDAMENTO: data e hora confirmadas] [DENTISTA: especialista] [ÚLTIMA_MENSAGEM_GI: nenhuma] [TAGS: tag_lead, tag_unidade_cidade, tag_agendado_sucesso, AGENDOU, Fluxo Agendou] [ORIGEM: orgânico] [PRÓXIMA_AÇÃO: entrar no E8 para confirmar o endereço e finalizar com carinho]`
