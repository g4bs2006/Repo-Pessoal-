...
- `[ESTÁGIO: E6] [NOME: primeiro nome] [NOME_COMPLETO: nome] [TELEFONE: telefone] [DOR: manter] [URGÊNCIA: manter] [OBJEÇÕES: cancelamento/remarcação] [ESTADO_EMOCIONAL: estado] [FRASES_CHAVE: "frase"] [AGENDAMENTO: novo ou cancelado] [DENTISTA: especialista] [ÚLTIMA_MENSAGEM_GI: nenhuma] [TAGS: tag_Remarcou/tag_Cancelou] [ORIGEM: orgânico] [PRÓXIMA_AÇÃO: arquivar contato / acompanhar retorno]`
