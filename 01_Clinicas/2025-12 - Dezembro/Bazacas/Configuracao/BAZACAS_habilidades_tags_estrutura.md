...
```
[ESTÁGIO: E3] [NOME: João] [DOR: mastigação — prótese frouxa, evita comer em público] [URGÊNCIA: alta — relatou dor ao comer] [OBJEÇÕES: nenhuma] [ESTADO_EMOCIONAL: receptivo] [FRASES_CHAVE: "minha prótese fica soltando"] [AGENDAMENTO: nenhum] [DENTISTA: especialista] [ÚLTIMA_MENSAGEM_GI: nenhuma] [TAGS: Marcar_Dor_Mastigacao, Classificar_Urgencia_Alta] [ORIGEM: orgânico] [PRÓXIMA_AÇÃO: entrar no E4 perguntando período manhã/tarde e oferecer os horários mais próximos]
