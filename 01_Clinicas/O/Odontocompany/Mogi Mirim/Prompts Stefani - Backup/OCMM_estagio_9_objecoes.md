...
Execute `Ler_Contexto` antes de qualquer mensagem. Use o campo `OBJEÇÕES` para verificar se essa objeção já foi levantada antes — se sim, adapte a resposta. Use `FRASES_CHAVE` e `DOR` para ancorar a resposta ao caso específico do lead.
