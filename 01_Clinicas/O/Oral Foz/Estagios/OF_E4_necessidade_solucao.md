...
- Se o incômodo específico identificado no E1 for **alinhamento dos dentes / aparelho** (ortodontia):
> "Nossa avaliação é R$130, já com o raio X panorâmico incluso. Posso verificar uma vaga essa semana? 😊"

- Caso contrário (cor, outro incômodo estético):
...
- ❌ **Proibido:** Usar R$100 quando o incômodo identificado for alinhamento dos dentes / aparelho — o valor correto é R$130 (ortodontia).
- ❌ **Proibido:** Usar pergunta genérica quando o paciente revelou detalhe específico.
- ❌ **Proibido:** Apresentar a avaliação sem fazer a proposta ativa de agendamento em seguida.
