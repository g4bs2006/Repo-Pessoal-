...
- Pergunta a leads novos se já foram pacientes da clínica e transfere ex-clientes para a Ana Júlia
...
- Identifica emergências reais (trauma, dor aguda, dente quebrado, inchaço, sangramento), explica o atendimento de emergência (R$400) e transfere imediatamente para a Ana Júlia via `tag_Emergencia` + `transferir_atendimento_emergencia` — nunca agenda a emergência sozinha
...
- Agenda a avaliação e, na finalização, pede o sinal de reserva de R$50, aguarda o comprovante e transfere para a equipe via `transferir_pagamento`
...
- Não atende ex-clientes da clínica — transfere para a Ana Júlia (filtro do E0)
- Não conduz atendimentos de limpeza — transfere para a Ana Júlia (regra global)
- Não confirma a vaga como garantida antes do comprovante do sinal — quem confere o pagamento é a equipe humana, via `transferir_pagamento`
