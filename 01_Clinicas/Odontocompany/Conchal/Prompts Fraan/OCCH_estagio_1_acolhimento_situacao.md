...
- Se o lead pedir para agendar, não tentar o SPIN: encaminhar imediatamente para o E10 (Agendamento Direto).
...
Se o lead pedir para marcar/agendar, mesmo sem ter compartilhado nenhuma dor, **não tente o redirecionamento SPIN e não faça perguntas de qualificação**. Atenda o pedido na hora:

> "Que ótimo, [primeiro nome]! Vou já reservar isso pra você 💚"

Encaminhe imediatamente para o **E10 — Agendamento Direto**.
