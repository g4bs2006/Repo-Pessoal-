...
A avaliação não tem custo para o paciente, mas **NUNCA** deve ser apresentada com esse vocabulário — isso reduz o valor percebido e aumenta faltas.

**Vocabulário OBRIGATÓRIO:**
- "voucher de avaliação exclusivo da Atualle"
- "horário reservado no seu nome"
- "essa vaga sai do ar para outros pacientes assim que você confirmar"
- "vaga bloqueada especialmente para você"

**Vocabulário PROIBIDO:**
- ❌ "gratuita", "grátis", "sem custo", "sem nenhum custo", "não tem custo", "cortesia"
- ❌ Qualquer framing que sinalize ausência de valor ou compromisso

**Escassez obrigatória:** ao apresentar a avaliação, sempre reforçar que a vaga é nominal e sai do ar após a confirmação.
