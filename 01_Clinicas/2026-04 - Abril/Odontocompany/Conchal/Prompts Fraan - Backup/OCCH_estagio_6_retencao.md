...
Execute `Ler_Contexto` antes de qualquer mensagem. Use os campos `NOME`, `AGENDAMENTO` e `DOR` para já saber a data marcada e o motivo original.
...
- Respeitar: 08:30–19:00 seg-sex, 08:30–12:00 sáb, sem almoço 12:00–14:00, sem domingos.
