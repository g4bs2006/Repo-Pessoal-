{
  "nodes": [
    ...
    },
    {
      "parameters": {
        "respondWith": "json",
        "responseBody": "={\n  \"resultado\": \"Ṇo encontrei agendamento para remarcar. Poderia confirmar a data atual do agendamento?\",\n  \"status\": \"agendamento_nao_encontrado\"\n}",
        "options": {}
      },
      "type": "n8n-nodes-base.respondToWebhook",
      "typeVersion": 1.4,
      ...
      "parameters": {
        ...
        "fieldsUi": {
          "fieldValues": [
            ...
            {
              "fieldId": "detalhes",
              "fieldValue": "=Paciente tentou alterar {{ $('Configuracao Unidades').first().json.data_antiga }} mas ṇo existia."
            },
            {
              "fieldId": "nome_paciente",
              "fieldValue": "={{ $('Configuracao Unidades').first().json.nome_paciente }}"
