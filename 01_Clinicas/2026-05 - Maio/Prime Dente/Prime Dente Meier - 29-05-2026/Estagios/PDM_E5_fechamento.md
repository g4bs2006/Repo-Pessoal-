...
> ⚠️ Unidade fixada: **Méier**. Execute `tag_Unidade_Meier` em silêncio antes de avançar para o Passo 1.

---

**Passo 1 — Oferta de Datas:**

Execute `verificar_disponibilidade` com `unidade = meier` antes de oferecer horários.
