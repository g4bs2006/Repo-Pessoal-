...
> ⚠️ Unidade fixada: **Botafogo**. Execute `tag_Unidade_Botafogo` em silêncio antes de avançar para o Passo 1.

---

**Passo 1 — Oferta de Datas:**

Execute `verificar_disponibilidade` com `unidade = botafogo` antes de oferecer horários.
