# -*- coding: utf-8 -*-
"""
Automacao: transfere cards das colunas "IA nao conseguiu agendar" e
"CRC nao conseguiu agendar" do painel Prime Odontocenter para o step
"Nao Agendou" do painel novo (Agendamentos), aplicando a etiqueta
...
Uso:
    python automacao_transferencia_nao_agendou.py                # dry-run (so mostra)
    python automacao_transferencia_nao_agendou.py --executar     # cria de fato
    python automacao_transferencia_nao_agendou.py --executar --limite 1   # teste com 1
"""
import sys
import time
import json
...
STEP_NAO_AGENDOU = "e587a27a-7f98-4140-9b04-1434f5c449e1"
...
# Steps de origem, na ordem em que serao inseridos no Nao Agendou
ORIGENS = [
    {"nome": "IA nao conseguiu agendar",  "stepId": "f79387f8-56fb-4d51-811c-4a06d3511ab8"},
    {"nome": "CRC nao conseguiu agendar", "stepId": "e98b1ea5-d5c7-4fb0-a7b2-9c639e4c5d05"},
]
...
def main():
    ...
    print("Listando cards existentes no step Nao Agendou do painel destino...")
    existentes = listar_todos(PAINEL_DESTINO, STEP_NAO_AGENDOU)
    ja_transferidos = set()
    for c in existentes:
